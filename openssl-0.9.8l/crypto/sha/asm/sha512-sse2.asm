...
@L000pic_point:
	pop	esi
	lea	esi,		[(@L001K512-@L000pic_point)+esi]
	sub	esp,		320
	and	esp,		-16
	movdqu	xmm0,		[edx]
	movdqu	xmm1,		[16+edx]
...
@L002_chunk_loop:
	...
	movdq2q	mm0,		xmm0
	movdq2q	mm1,		xmm2
	mov	eax,		DWORD [edx*8+edi]
	mov	ebx,		DWORD [4+edx*8+edi]
	bswap	eax
	bswap	ebx
	mov	DWORD [edx*8+esp],ebx
	mov	DWORD [4+edx*8+esp],eax
	mov	DWORD [128+edx*8+esp],ebx
	mov	DWORD [132+edx*8+esp],eax
align	8
@L003_1st_loop:
	mov	eax,		DWORD [8+edx*8+edi]
	mov	ebx,		DWORD [12+edx*8+edi]
	bswap	eax
	bswap	ebx
	mov	DWORD [8+edx*8+esp],ebx
	mov	DWORD [12+edx*8+esp],eax
	mov	DWORD [136+edx*8+esp],ebx
	mov	DWORD [140+edx*8+esp],eax
@L004_1st_looplet:
	movq	mm4,		[296+esp]
	movq	mm5,		[304+esp]
	movq	mm6,		[312+esp]
	...
	inc	edx
	cmp	edx,		15
	jl NEAR	@L003_1st_loop
	je NEAR	@L004_1st_looplet
	mov	ebx,		edx
align	8
@L005_2nd_loop:
	and	edx,		15
	movdqu	xmm0,		[8+edx*8+esp]
	movdqa	xmm2,		xmm0
	movdqa	xmm3,		xmm0
	psrlq	xmm2,		1
	psllq	xmm3,		56
	...
	psrlq	xmm4,		42
	pxor	xmm1,		xmm4
	movdqu	xmm6,		[72+edx*8+esp]
	paddq	xmm0,		xmm1
	paddq	xmm0,		xmm6
	paddq	xmm0,		[edx*8+esp]
	movdqa	[edx*8+esp],	xmm0
	movdqa	[128+edx*8+esp],xmm0
	movq	mm4,		[296+esp]
	movq	mm5,		[304+esp]
	movq	mm6,		[312+esp]
	movq	mm2,		mm1
